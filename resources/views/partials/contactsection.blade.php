...
<div class="container-fluid py-5 mb-5">
    <div class="container">
        <div class="text-center mx-auto pb-5 wow fadeIn" data-wow-delay=".3s" style="max-width: 600px;">
            ...
            <p class="mb-2">Have a question, comment, or need assistance? Feel free to reach out to our team at RAMTEK Communications. We're committed to providing prompt and helpful responses to all inquiries.
            ...
            <div class="row g-5 mb-5 justify-content-center">
                ...
                <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".5s">
                    <div class="d-flex bg-light p-3 rounded">
                        ...
                        <div class="ms-3">
                            ...
                            <a class="h5" href="tel:+12146796818" target="_blank">+1 214-679-6818</a>
                        </div>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-6 wow fadeIn" data-wow-delay=".7s">
                    <div class="d-flex bg-light p-3 rounded">
                        ...
                        <div class="ms-3">
                            <h4 class="text-primary">Fax Us</h4>
                            <p class="h5">972-247-8155</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay=".3s">
                    <div class="p-5 h-100 rounded contact-map">
                        <iframe class="rounded w-100 h-100" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3349.5054986245464!2d-96.88831812562643!3d32.91124027711674!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x864c27000a80ab55%3A0x9659df6231121e7d!2sRAMTEK%20Network%20Solutions!5e0!3m2!1sen!2s!4v1725035069616!5m2!1sen!2s" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
