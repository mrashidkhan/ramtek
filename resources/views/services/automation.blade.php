    ...
    <div class="container pt-5">
        <div class="row g-5">
            ...
            <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                <h5 class="text-primary">Automation</h5>
                <h1 class="mb-4">RAMTEK Communications Automation Services</h1>
                <p>Finding and hiring 10X talent takes valuable time and resources. When you work with RAMTEK Communications, you get a dedicated team of expert web and mobile app developers who are ready to get to work for you.</p>
